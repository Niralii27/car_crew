...
class AdminAddSOSCategory extends StatefulWidget {
  const AdminAddSOSCategory({Key? key}) : super(key: key);

  @override
  State<AdminAddSOSCategory> createState() => _AdminAddSOSCategoryState();
}

class _AdminAddSOSCategoryState extends State<AdminAddSOSCategory> {
  ...
  Future<void> _saveCategory() async {
    ...
    try {
        ...
        SnackBar(
          content: Row(
            children: const [
              ...
              SizedBox(width: 10),
              Text('SOS Category added successfully!'),
            ],
          ),
      ...
      ScaffoldMessenger.of(context).showSnackBar(
        SnackBar(content: Text('Failed to save SOS category: $e')),
      );
    } finally {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        title: const Text('Add Car Service SOS Category'),
        elevation: 2,
      ),
      body: _isLoading
