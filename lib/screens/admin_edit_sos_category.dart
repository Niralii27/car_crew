...
class EditSOSCategoryScreen extends StatefulWidget {
  final String serviceId;

  const EditSOSCategoryScreen({Key? key, required this.serviceId})
      : super(key: key);

  @override
  State<EditSOSCategoryScreen> createState() => _EditSOSCategoryScreenState();
}

class _EditSOSCategoryScreenState extends State<EditSOSCategoryScreen> {
